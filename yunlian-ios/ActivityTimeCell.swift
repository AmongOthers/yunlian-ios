...
class ActivityTimeCell: ActivityBaseCell {
    ...
    override func setupViews() {
        ...
        rightView.image = UIImage(named: "time")
        rightView.contentMode = UIViewContentMode.Center
        rightView.userInteractionEnabled = true
        rightView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: "tiemTapped"))
